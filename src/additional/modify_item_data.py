...
class ModifyItemData (object):
    def __init__(self, SHA):
        ...
        _alt_set(self.Entry_url_1, T.ANNOTATION_GET_URL)
        _alt_set(self.Entry_url_2, T.ANNOTATION_GET_URL)
        _alt_set(self.Entry_url_3, T.ANNOTATION_GET_URL)
        _alt_set(self.Combobox_mode_1, T.ANNOTATION_GET_MODE)
        _alt_set(self.Combobox_mode_2, T.ANNOTATION_GET_MODE)
        _alt_set(self.Combobox_mode_3, T.ANNOTATION_GET_MODE)
        _alt_set(self.Button_ok, T.ANNOTATION_MODIFY_ITEM_OK)
        _alt_set(self.Button_cancel, T.ANNOTATION_MODIFY_ITEM_CANCEL)
        _alt_set(self.Button_remove, T.ANNOTATION_MODIFY_ITEM_REMOVE)
        _alt_set(self.Button_delete, T.ANNOTATION_MODIFY_ITEM_DELETE)
